...
//        Parent numPlayers = FXMLLoader.load(getClass().getResource("/resources/number_players.fxml"));
...
//            ArrayList<Player> plyrs = boardManager.getBoard().getPlayers();
//            final BoardManager manager = BoardManager.getInstance(np);
